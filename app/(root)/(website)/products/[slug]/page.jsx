...
const ProductDetailPage = async ({ params }) => {
  ...
  return (
    <section className="min-h-screen bg-[#f4fff6] py-10 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4">
        ...
        <div className="flex flex-wrap items-center gap-2 text-sm text-gray-600 mb-8">
          ...
          <Link href={WEBSITE_LISTING} className="hover:text-green-700 transition">
            Products
          </Link>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <span className="bg-orange-100 text-orange-700 text-sm px-4 py-1 rounded-full font-medium">
                {product.subcategory}
              </span>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {product.color.map((color, index) => (
                  <span
                    key={index}
                    className="bg-white border border-gray-200 px-4 py-1 rounded-xl text-sm text-gray-700 shadow-sm"
                  >
                    {color}
                  </span>
                ))}
